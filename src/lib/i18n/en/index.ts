...
const en = {
	...
	cv: {
		...
		experienceLocation1: 'Turku, Finland',
		experienceDate1: '2021 - Present',
		experienceDesc1_1: 'Lead developer in multiple projects',
		experienceDesc1_2: 'Working with multiple tech stacks on different customer projects',
		experienceTitle2: 'Trainee, Technology',
		experienceCompany2: 'Oras Oy',
		experienceLocation2: 'Rauma, Finland',
		experienceDate2: '2020 - 2021',
		experienceDesc2_1: 'Responsible for developing sensor firmware on products used by customers',
		experienceDesc2_2: 'Building prototypes for upcoming products',
		education: 'Education',
		educationDegree1: 'Master of Science (Technology)',
		educationInstitution1: 'University of Turku',
		educationLocation1: 'Turku, Finland',
